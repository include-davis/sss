...
const reward_list = [
  {
    reward_lvl: "Voyager I",
    amount: "$10,000+",
    reward: [
      "Collaboration with company/donor to aid corporate marketing and recruitment efforts (Photo Ops, Articles, etc.)",
  ...
  },
  {
    ...
    amount: "$5,000+",
    reward: [
      "Large Logo on the website and logo on the satellite",
      "Includes all benefits from previous tiers",
    ],
  },
  {
    reward_lvl: "Opportunity",
    amount: "$1,000+",
    reward: [
      "Donor name listed on Club merchandise",
      "Access to leadership resume packet",
      "Includes all benefits from previous tiers",
    ],
  },
  {
    reward_lvl: "Apollo 11",
    amount: "$500+",
    reward: [
      "Club Social Media Recognition",
      "Includes all benefits from previous tiers",
    ],
  },
  {
    reward_lvl: "Sputnik I",
    amount: "$100+",
    reward: ["Thank you Letter", "Donor name listed on SSS website"],
  },
];
    ...
    <div className={styles.container}>
      <div className={styles.childrenContainer}>
        ...
        <div className={styles.SponsorPacket}>
          ...
          <a
            href="https://www.spacesystemsclub.org/_files/ugd/f86cee_85751d3b7a5a4da8b381fa0181e633bd.pdf"
            className={styles.SponsorPacketButton}
          >
