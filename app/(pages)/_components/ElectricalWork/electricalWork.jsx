...
export default function ElectricalWork() {
  const CARDS = [
    ...
    {
      img: "/ElectronicSpeedController.jpg",
    ...
    <section className={styles.section}>
      <div className={styles.topText}>
        ...
        <p className={styles.sectionDescription}>
          Our Electrical Department has been hard at work these past few years
          to create many custom PCBs for the satellite. The work involved
          includes using KiCad for design, soldering and assembly for PCBs, and
          rigorous testing
        </p>
      </div>
