  ...
  return (
    ...
    <div className={styles.pageBody}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.softwareDescription}>Our Software team focuses mainly on the embedded software and writing our custom operating system on the orbital platform called IntelliSat. IntelliSat is written fully in C, has bare metal drivers, and uses FreeRTOS to schedule mission tasks. Work in Software involves using STM32CubeIDE, looking at datasheets, documentation, looking at schematics, and embedded C</p>
        <button>IntelliSat - GitHub</button>
        <button>Radio Controller - GitHub</button>
        <button>MGT Controller - GitHub</button>
